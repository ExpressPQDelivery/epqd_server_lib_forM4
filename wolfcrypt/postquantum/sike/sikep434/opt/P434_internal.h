...
unsigned int sike_mp_add(const digit_t* a, const digit_t* b, digit_t* c, const unsigned int nwords);
...
unsigned int sike_mp_sub(const digit_t* a, const digit_t* b, digit_t* c, const unsigned int nwords);
...
void sike_mp_mul(const digit_t* a, const digit_t* b, digit_t* c, const unsigned int nwords);
