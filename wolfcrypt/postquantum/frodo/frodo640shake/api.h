...
#define CRYPTO_ALG_NAME		   PQCLEAN_FRODOKEM640SHAKE_CLEAN_CRYPTO_ALGNAME


#define crypto_kem_keypair(pk,sk)			PQCLEAN_FRODOKEM640SHAKE_CLEAN_crypto_kem_keypair((pk),(sk))
#define crypto_kem_enc(ct,ss,pk)			PQCLEAN_FRODOKEM640SHAKE_CLEAN_crypto_kem_enc(ct,ss,pk)
#define crypto_kem_dec(ss,ct,sk)			PQCLEAN_FRODOKEM640SHAKE_CLEAN_crypto_kem_dec(ss,ct,sk)
