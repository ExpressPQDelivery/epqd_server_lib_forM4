...
#define CRYPTO_SECRETKEYBYTES  PQCLEAN_HQCRMRS256_CLEAN_CRYPTO_SECRETKEYBYTES
#define CRYPTO_PUBLICKEYBYTES  PQCLEAN_HQCRMRS256_CLEAN_CRYPTO_PUBLICKEYBYTES
#define CRYPTO_BYTES           PQCLEAN_HQCRMRS256_CLEAN_CRYPTO_BYTES
#define CRYPTO_CIPHERTEXTBYTES PQCLEAN_HQCRMRS256_CLEAN_CRYPTO_CIPHERTEXTBYTES
#define CRYPTO_ALGNAME 		   PQCLEAN_HQCRMRS256_CLEAN_CRYPTO_ALGNAME

#define crypto_kem_keypair(pk,sk)			PQCLEAN_HQCRMRS256_CLEAN_crypto_kem_keypair((pk),(sk))
#define crypto_kem_enc(ct,ss,pk)			PQCLEAN_HQCRMRS256_CLEAN_crypto_kem_enc(ct,ss,pk)
#define crypto_kem_dec(ss,ct,sk)			PQCLEAN_HQCRMRS256_CLEAN_crypto_kem_dec(ss,ct,sk)
