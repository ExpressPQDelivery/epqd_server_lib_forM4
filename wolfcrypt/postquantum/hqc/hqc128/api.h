...
#define crypto_kem_keypair(pk,sk)			PQCLEAN_HQCRMRS128_CLEAN_crypto_kem_keypair((pk),(sk))
#define crypto_kem_enc(ct,ss,pk)			PQCLEAN_HQCRMRS128_CLEAN_crypto_kem_enc(ct,ss,pk)
#define crypto_kem_dec(ss,ct,sk)			PQCLEAN_HQCRMRS128_CLEAN_crypto_kem_dec(ss,ct,sk)
