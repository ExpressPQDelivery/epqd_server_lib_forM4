...
#define CRYPTO_SECRETKEYBYTES  PQCLEAN_NTRULPR653_CLEAN_CRYPTO_SECRETKEYBYTES
#define CRYPTO_PUBLICKEYBYTES  PQCLEAN_NTRULPR653_CLEAN_CRYPTO_PUBLICKEYBYTES
#define CRYPTO_BYTES           PQCLEAN_NTRULPR653_CLEAN_CRYPTO_BYTES
#define CRYPTO_CIPHERTEXTBYTES PQCLEAN_NTRULPR653_CLEAN_CRYPTO_CIPHERTEXTBYTES

#define crypto_kem_keypair(pk,sk)			PQCLEAN_NTRULPR653_CLEAN_crypto_kem_keypair((pk),(sk))
#define crypto_kem_enc(ct,ss,pk)			PQCLEAN_NTRULPR653_CLEAN_crypto_kem_enc(ct,ss,pk)
#define crypto_kem_dec(ss,ct,sk)			PQCLEAN_NTRULPR653_CLEAN_crypto_kem_dec(ss,ct,sk)

#define PQCLEAN_randombytes randombytes

#define PQCLEAN_NTRULPR_CRYPTO_ALGNAME PQCLEAN_NTRULPR653_CLEAN_CRYPTO_ALGNAME
