...
#define CRYPTO_PUBLICKEYBYTES 	PQCLEAN_FALCON1024_CLEAN_CRYPTO_PUBLICKEYBYTES
#define CRYPTO_SECRETKEYBYTES 	PQCLEAN_FALCON1024_CLEAN_CRYPTO_SECRETKEYBYTES
#define CRYPTO_BYTES 			PQCLEAN_FALCON1024_CLEAN_CRYPTO_BYTES

#define HAVE_FALCON1024

#define crypto_sign_signature(sig,siglen,m,mlen,sk) 	PQCLEAN_FALCON1024_CLEAN_crypto_sign_signature(sig,siglen,m,mlen,sk)
#define crypto_sign_verify(sig,siglen,m,mlen,pk) 		PQCLEAN_FALCON1024_CLEAN_crypto_sign_verify(sig,siglen,m,mlen,pk)
