...
#define crypto_sign_signature(sig,siglen,m,mlen,sk) 	PQCLEAN_FALCON512_CLEAN_crypto_sign_signature(sig,siglen,m,mlen,sk)
#define crypto_sign_verify(sig,siglen,m,mlen,pk) 		PQCLEAN_FALCON512_CLEAN_crypto_sign_verify(sig,siglen,m,mlen,pk)
