...
#ifdef HAVE_POSTQUANTUM				/*   PQ Signature OIDs   */
	CTC_DILITHIUM_LEVEL1 		= 213,	/* 1.3.6.1.4.1.2.267.7.4.4 */
	CTC_DILITHIUM_LEVEL3 		= 216, 	/* 1.3.6.1.4.1.2.267.7.6.5 */
	CTC_DILITHIUM_LEVEL5 		= 220, 	/* 1.3.6.1.4.1.2.267.7.8.7 */
	CTC_FALCON_LEVEL1 			= 268, 	/* 1.3.9999.3.1 */
	CTC_FALCON_LEVEL5 			= 271, 	/* 1.3.9999.3.4 */
	CTC_PICNIC3_LEVEL1			= 353,  /* 1.3.6.1.4.1.311.89.2.1.21 */
	CTC_SPHINCSFSIMPLE_LEVEL1 	= 278, 	/* 1.3.9999.6.4.4 */
	CTC_SPHINCSSSIMPLE_LEVEL1 	= 284 	/* 1.3.9999.6.4.10 */
