...
static WC_INLINE void EncodeSigAlg(byte hashAlgo, byte hsType, byte* output)
{
    switch (hsType) {
        ...
        case dilithium_level3_sa_algo:
        	output[1] = dilithium_level3_sa_algo;
        	output[0] = hashAlgo;
        	break;
        case dilithium_level1_sa_algo:
        	output[1] = dilithium_level1_sa_algo;
        	output[0] = hashAlgo;
        	break;
	#endif
	#ifdef HAVE_FALCON
        case falcon_level5_sa_algo:
        	output[1] = falcon_level5_sa_algo;
        	output[0] = hashAlgo;
        	break;
        case falcon_level1_sa_algo:
        	output[1] = falcon_level1_sa_algo;
        	output[0] = hashAlgo;
        	break;
	#endif
#endif /* HAVE_POSTQUANTUM */
...
#ifdef HAVE_POSTQUANTUM
            else if (ssl->hsType == DYNAMIC_TYPE_POSTQUANTUM)
            	args->sigAlgo = ssl->suites->sigAlgo;
#endif /* HAVE_POSTQUANTUM */
        #ifdef HAVE_ECC
                                    ...
                                    word32* inOutIdx, word32 totalSz)
{
    ...
    switch(ssl->options.asyncState)
    {
        ...
        case TLS_ASYNC_BUILD:
        {
            ...
            // OVERRIDE ENCRYPT_LEN only for Postquantum
        ...
        #endif
#ifdef HAVE_POSTQUANTUM // OVERWRITE EXISTING CODE
//				CREATING THE BUFFER FOR THE SIGNATURE
...
//            	CREATING THE BUFFER FOR DATA TBS(To Be Signed)
            args->sigData = (byte*)XMALLOC(MAX_SIG_DATA_SZ, ssl->heap,
                                                    DYNAMIC_TYPE_SIGNATURE);
        ...
        case TLS_ASYNC_VERIFY:
        {
            ...
            if (ssl->peerFalconKey != NULL && ssl->peerFalconKeyPresent != 0) {
            	...
            	/* Verify the signature */
                ret = crypto_sign_verify(sig->buffer, sig->length,
                		args->sigData, args->sigDataSz, ssl->peerFalconKey);
            }
